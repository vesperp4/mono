      ...
      <div className="container-main">
        ...
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24 items-start">
          ...
          >
            ...
            <motion.p variants={item} className="text-base mb-5 leading-relaxed" style={{ color: "rgba(240,242,245,0.65)" }}>
              VESPER P4 was born from a recognized gap within the ECECS Department at
              Polytechnic University of Puerto Rico (PUPR). Engineering students navigating
              cybersecurity, artificial intelligence, and the broader landscape of national
              security had no unified academic community — no forum where those disciplines
              could collide and compound.
            </motion.p>

            <motion.p variants={item} className="text-base mb-10 leading-relaxed" style={{ color: "rgba(240,242,245,0.65)" }}>
              We exist to change that. VESPER P4 brings together practitioners, researchers,
              and builders under four integrated pillars, offering students the structured
              environment and real-world mentorship needed to develop skills that matter
            ...
            >
              ...
              <p className="text-lg font-bold mb-2" style={{ fontFamily: "var(--font-orbitron)", color: "#f0f2f5" }}>
                Vesper — Evening Star
              </p>
              <p className="text-sm leading-relaxed" style={{ color: "rgba(240,242,245,0.55)" }}>
                From the Latin <em>vesper</em>, meaning evening or the western star — Venus as
                seen at dusk. Like the evening star that bridges day and night, VESPER P4
                bridges the disciplines that define modern defense and technology. Brightest
                when others fade.
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            >
              <Image
                src="/images/vesper-stars-lineup.png"
                alt="VESPER Stars"
                width={360}
                height={80}
