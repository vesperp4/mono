...
export default function Founders() {
  ...
  return (
    <section id="founders" ref={ref} className="section" style={{background: 'var(--bg)'}}>
          ...
          >
            ...
            >
              ...
              <p className="text-sm leading-relaxed" style={{color: 'rgba(240,242,245,0.55)'}}>
                Guiding VESPER P4 with expertise at the intersection of engineering, technology
                policy, and applied research. A practitioner who builds with the technologies being
                taught.
              </p>
            </div>
          </motion.div>
