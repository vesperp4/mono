  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, transparent 40%, rgba(2,3,4,0.7) 100%)",
        }}
      />

      {/* Content */}
      <motion.div
        className="relative z-10 text-center container-main"
      ...
      >
        ...
        <motion.h1
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.7, duration: 1, ease: [0.16, 1, 0.3, 1] as [number, number, number, number] }}
