...
export default function Join() {
  ...
  return (
    <section id="join" ref={ref} className="section" style={{background: 'var(--surface)'}}>
      <div className="container-main">
        ...
        >
          ...
          >
            We seek members who want to <span style={{color: '#2563eb'}}>build</span>, not just
            discuss.
          </h2>
          <p
          ...
          >
            VESPER P4 is not a passive student club. It is a mission-driven association for those
            who take their work seriously and want to contribute to something larger than a course
            requirement.
          </p>
        </motion.div>
