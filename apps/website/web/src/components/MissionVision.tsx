...
export default function MissionVision() {
  ...
  return (
    <section id="mission" ref={ref} className="section" style={{background: 'var(--surface-2)'}}>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20">
          ...
          >
            ...
            <p className="text-base leading-relaxed" style={{color: 'rgba(240,242,245,0.7)'}}>
              To cultivate a collaborative academic community that advances knowledge and practical
              skills across cybersecurity, AI, Engineering, national security and defense, while
              fostering meaningful connections among like-minded individuals passionate about
              technology and its real-world impact — all led by practitioners who build with the
          ...
          >
            ...
            <p className="text-base leading-relaxed" style={{color: 'rgba(240,242,245,0.7)'}}>
              To provide students with a structured yet inclusive environment to explore advanced
              technologies, develop hands-on expertise under the guidance of those who actively work
              in the field, and engage in interdisciplinary discussions, while serving as a platform
              for networking, collaboration, and shared intellectual curiosity.
            </p>
          </motion.div>
        </div>
