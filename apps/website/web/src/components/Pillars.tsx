...
export default function Pillars() {
  ...
  return (
    <section id="pillars" ref={ref} className="section" style={{background: 'var(--surface)'}}>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          ...
          >
            <p className="text-base leading-relaxed" style={{color: 'rgba(240,242,245,0.55)'}}>
              ...
              integrated framework for understanding and shaping the future of technology and
              national security.
            </p>
          </motion.div>
        </div>
